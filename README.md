...
- `uses: actions/upload-artifact@*` / `uses: actions/download-artifact@*` の最小 builtin emulator (`directory`, wildcard path, download-all directory mode)
